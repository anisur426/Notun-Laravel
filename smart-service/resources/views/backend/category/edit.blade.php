          ...
          <div class="card card-outline">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" name="cat_name" value="{{!old('cat_name')? $category->name:old('cat_name')}}" class="form-control" id="exampleInputEmail1" placeholder="Enter a category name">
              </div>
