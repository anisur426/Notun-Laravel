        ...
        <div class="col-lg-12">
          <div class="card card-outline">
            <div class="card-header bg-blue">
              <h5 class="text-white m-b-0">Category Entry</h5>
            </div>
            <div class="card-body">
              @if($errors->any())
              ...
              <div class="form-group">
                ...
                <input type="text" name="prod_name" value="{{old('prod_name')}}" class="form-control" id="exampleInputEmail1" placeholder="Enter a category name">
              </div>
              <div class="form-group">
                <label for="exampleInputEmail1">Product Details</label>
                <input type="text" name="details" value="{{old('prod_name')}}" class="form-control" id="exampleInputEmail1">
              </div>
               <div class="form-group">
                <label for="exampleInputEmail1">SKU</label>
                <input type="text" name="sku" value="{{old('prod_name')}}" class="form-control" id="exampleInputEmail1" placeholder="Enter a category name">
              </div>
               <div class="form-group">
                <label for="exampleInputEmail1">Stock</label>
                <input type="text" name="stock" value="{{old('prod_name')}}" class="form-control" id="exampleInputEmail1" placeholder="Enter a category name">
              </div>
               <div class="form-group">
                <label for="exampleInputEmail1">Price</label>
                <input type="text" name="price" value="{{old('prod_name')}}" class="form-control" id="exampleInputEmail1" placeholder="Enter a category name">
              </div>
               <div class="form-group">
