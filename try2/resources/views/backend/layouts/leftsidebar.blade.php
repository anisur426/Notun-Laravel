      <div class="main-menu">
            ...
            <div class="logo-box">
                ...
                <a href="index.html" class="logo-dark">
                    <img src="{{asset('dist/assets/images/logo-dark.png')}}" alt="dark logo" class="logo-lg" height="28">
                    <img src="{{asset('dist/assets/images/logo-sm.png')}}" alt="small logo" class="logo-sm" height="28">
                </a>
            </div>
                ...
                <ul class="app-menu">
                    ...
                    <li class="menu-item">
                        <a href="#menuLayouts" data-bs-toggle="collapse" class="menu-link waves-effect waves-light">
                            ...
                            <span class="menu-text">Product</span><i class="fa fa-angle-left pull-right"></i>
